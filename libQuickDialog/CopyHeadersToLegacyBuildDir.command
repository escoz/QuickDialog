...
IFS=$'\n'
if [ -d "${TARGET_BUILD_DIR}/include/QuickDialog" ]; then
    rsync -av --delete "${TARGET_BUILD_DIR}/include/QuickDialog" "${SOURCE_ROOT}/Build"
else
...
if [ -d "${TARGET_BUILD_DIR}/include/QuickDialog" ]; then
cd ${TARGET_BUILD_DIR}/include/QuickDialog
