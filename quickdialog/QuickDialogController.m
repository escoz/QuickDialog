...
- (void)loadView {
    ...
    self.quickDialogTableView.frame = CGRectMake(0.0f,0.0f,frameSize.width, frameSize.height);
    self.quickDialogTableView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
