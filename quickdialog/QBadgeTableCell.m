...
- (void)layoutSubviews {
    ...
    self.textLabel.frame = CGRectMake(lblFrame.origin.x, lblFrame.origin.y, rect.size.width-lblFrame.origin.x-_badgeLabel.frame.size.width-20, lblFrame.size.height);
}
